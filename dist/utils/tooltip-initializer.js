    ...
    const initTipNixTooltip = useCallback((options = {}) => {
        ...
        tooltipWrapper.forEach((wrapper) => {
            ...
            tooltipTextElement.style.width =
              tooltipWidth > windowWidth ? `${windowWidth / 3}px` : customWidth ? customWidth : width ? width : "225px";
          console.log(tooltipWidth > windowWidth ? `${windowWidth / 3}px` : customWidth ? customWidth : width ? width : "225px");
