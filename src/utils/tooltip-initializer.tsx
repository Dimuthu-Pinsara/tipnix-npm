...
export function useTooltip(options: TooltipOptions = {}) {
  ...
  const initTipNixTooltip = useCallback((options: TooltipOptions = {}) => {
    const {
      textColor = "#ffffff",
    ...
    tooltipWrapper.forEach((wrapper) => {
      ...
      const wrapperWidth = (wrapper as HTMLElement).offsetWidth / 2
    ...
    tooltipElements.forEach((tooltipElement) => {
      tooltipElement.addEventListener("mouseenter", (event) => {
        ...
        const tooltipContentElement = element.querySelector(".tooltip") as HTMLElement
  ...
  function tipnixTooltipSetTopPosition(wrapElement: HTMLElement, contentElement: HTMLElement) {
